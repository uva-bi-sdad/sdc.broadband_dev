...
#data
dat_broadband <- read.csv("~/git/sdc.broadband_dev/legacy/data/dc.broadbandnow.broadband.prices/distr/dcmdva_hdcttrbg_2021_broadband_now_internet_package_price.csv.xz")
#county id
